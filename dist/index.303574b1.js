...
})({"23m5W":[function(require,module,exports) {
"use strict";
...
(0, _preact.render)((0, _preact.h)((0, _appComponentDefault.default), null), root, target);

},{"preact":"26zcy","./components/app.component":"lsqAR","bootstrap/dist/css/bootstrap.min.css":"i5LP7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"26zcy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
function App() {
    return (0, _preact.h)("section", null, (0, _preact.h)((0, _headerComponentDefault.default), null), (0, _preact.h)((0, _preactRouterDefault.default), null, (0, _preact.h)((0, _homeRouteDefault.default), {
        path: "/"
    }), (0, _preact.h)((0, _preactAsyncRouteDefault.default), {
        path: "/results",
        getComponent: function() {
            return require("cadc159f09097af6").then(function(module) {
...
},{"preact":"26zcy","preact-router":"e4tGw","preact-async-route":"kqZFf","./header.component":"gPc3n","../routes/home.route":"i5wVF","cadc159f09097af6":"1UFii","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e4tGw":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _preact = require("preact");
var t, u, r, o = 0, i = [], c = (0, _preact.options).__b, f = (0, _preact.options).__r, e = (0, _preact.options).diffed, a = (0, _preact.options).__c, v = (0, _preact.options).unmount;
function m(t1, r1) {
    (0, _preact.options).__h && (0, _preact.options).__h(u, t1, o || r1), o = 0;
    var i1 = u.__H || (u.__H = {
        __: [],
        __h: []
    });
...
function y(r3, o2) {
    var i3 = m(t++, 3);
    !(0, _preact.options).__s && k(i3.__H, o2) && (i3.__ = r3, i3.__H = o2, u.__H.__h.push(i3));
}
function h(r4, o3) {
    var i4 = m(t++, 4);
    !(0, _preact.options).__s && k(i4.__H, o3) && (i4.__ = r4, i4.__H = o3, u.__h.push(i4));
}
function s(n) {
...
(0, _preact.options).__b = function(n) {
    ...
    e && e(t7);
    var o6 = t7.__c;
    o6 && o6.__H && o6.__H.__h.length && (1 !== i.push(o6) && r === (0, _preact.options).requestAnimationFrame || ((r = (0, _preact.options).requestAnimationFrame) || function(n) {
        var t8, u5 = function() {
    ...
    u6.some(function(t10) {
        try {
            ...
            u6.some(function(n) {
                n.__h && (n.__h = []);
            }), u6 = [], (0, _preact.options).__e(r10, t10.__v);
        }
    }), a && a(t9, u6);
    ...
    if (u7 && u7.__H) try {
        ...
        (0, _preact.options).__e(t12, u7.__v);
    }
};
...
var _headerModuleLess = require("../less/header.module.less");
function HeaderComponent() {
    return (0, _preact.h)("header", {
        className: _headerModuleLess["header"] + " full-bleed"
    }, (0, _preact.h)("div", {
        className: "wrapper"
    }, (0, _preact.h)((0, _match.Link), {
...
},{"preact":"26zcy","preact-router/match":"acZU6","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/header.module.less":"cd9hj"}],"acZU6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function l(a) {
    var e = (0, _preactRouter.useRouter)()[0];
    return a.children({
        url: e.url,
        path: e.path,
        matches: !1 !== (0, _preactRouter.exec)(e.path || e.url, a.path, {})
    });
}
function c(l1) {
    var c1 = l1.className, n = l1.activeClass, u = l1.activeClassName, i = l1.path, p = function(a, t) {
        ...
        return s1;
    }(l1, s), h = (0, _preactRouter.useRouter)()[0], f = i && h.path && (0, _preactRouter.exec)(h.path, i, {}) || (0, _preactRouter.exec)(h.url, p.href, {}), o = p.class || c1 || "", m = f && (n || u) || "";
    return p.class = o + (o && m && " ") + m, (0, _preact.h)((0, _preactRouter.Link), p);
}

},{"preact":"26zcy","preact-router":"e4tGw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"cd9hj":[function(require,module,exports) {
module.exports["header"] = `_70fKAq_header`;
...
function HomeRoute() {
    return (0, _preact.h)("section", null, (0, _preact.h)((0, _searchComponentDefault.default), null), (0, _preact.h)("h1", null, (0, _search.HOME_PAGE_HEADING_TEXT)), (0, _preact.h)("p", null, (0, _search.HOME_PAGE_DESC_1)), (0, _preact.h)("p", null, (0, _search.HOME_PAGE_DESC_2)));
}
exports.default = HomeRoute;

},{"preact":"26zcy","../components/search.component":"dTUIm","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../consts/search":"41r2A"}],"dTUIm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _preact = require("preact");
var _search = require("../consts/search");
...
var _searchModuleLess = require("../less/search.module.less");
...
function SearchComponent() {
    var _a1, _b, _c, _d;
    var _e = __read((0, _preactRouter.useRouter)(), 1), searchParams = _e[0];
    var onSubmit = function(e) {
        ...
        (0, _preactRouter.route)(url, true);
    };
    return (0, _preact.h)("section", {
    ...
    }, (0, _preact.h)((0, _selectComponent.SelectComponent), {
        name: "location",
        label: "Destination",
        id: "location_field",
        value: ((_a1 = searchParams === null || searchParams === void 0 ? void 0 : searchParams.matches) === null || _a1 === void 0 ? void 0 : _a1.location) || "",
        options: (0, _search.LOCATIONS),
        required: true
    })), (0, _preact.h)("div", {
        className: _searchModuleLess["col"]
    }, (0, _preact.h)((0, _dateComponent.DateComponent), {
        name: "departureDate",
        label: "Date",
        id: "departureDate",
        ...
        className: _searchModuleLess["col"]
    }, (0, _preact.h)((0, _numberComponent.NumberComponent), {
        name: "duration",
        label: "Duration",
        id: "duration_field",
        min: 1,
        ...
        className: _searchModuleLess["col"]
    }, (0, _preact.h)((0, _buttonComponent.ButtonComponent), {
        text: "Search",
        type: "SUBMIT"
    }))))));
}
...
},{"preact":"26zcy","../consts/search":"41r2A","./button.component":"bvkZO","./date.component":"hfKWr","./select.component":"7w5lx","preact-router":"e4tGw","./number.component":"3KUrv","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/search.module.less":"4D7r1"}],"41r2A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "LOCATIONS", ()=>LOCATIONS);
parcelHelpers.export(exports, "FACILITIES", ()=>FACILITIES);
parcelHelpers.export(exports, "HOME_PAGE_HEADING_TEXT", ()=>HOME_PAGE_HEADING_TEXT);
parcelHelpers.export(exports, "HOME_PAGE_DESC_1", ()=>HOME_PAGE_DESC_1);
parcelHelpers.export(exports, "HOME_PAGE_DESC_2", ()=>HOME_PAGE_DESC_2);
var LOCATIONS = [
    {
        value: "new-york",
...
var HOME_PAGE_HEADING_TEXT = "Holiday Search Test";
var HOME_PAGE_DESC_1 = "We have provided a simple search panel for testing using `preact-router`.";
var HOME_PAGE_DESC_2 = "We have made the request to our search service and added a proxy in the `/results` route in `src/routes/results.route.tsx`.<";
...
/** @jsx h */ var _preact = require("preact");
var _buttonModuleLess = require("../less/button.module.less");
...
},{"preact":"26zcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/button.module.less":"hVY8A"}],"hVY8A":[function(require,module,exports) {
module.exports["skin-secondary"] = `LNu2Ea_skin-secondary`;
module.exports["button"] = `LNu2Ea_button`;

},{}],"hfKWr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "DateComponent", ()=>DateComponent);
/** @jsx h */ var _preact = require("preact");
var _dateModuleLess = require("../less/date.module.less");
var _luxon = require("luxon");
var DateComponent = function(props) {
    var format = "yyyy-MM-dd";
    var min = (0, _luxon.DateTime).now().plus({
        days: 3
    }).toFormat(format);
    var max = (0, _luxon.DateTime).now().plus({
        months: 12
    }).toFormat(format);
    var value = (props === null || props === void 0 ? void 0 : props.value) ? (0, _luxon.DateTime).fromFormat(props === null || props === void 0 ? void 0 : props.value, format).toFormat(format) : (0, _luxon.DateTime).now().plus({
        days: 7
    }).toFormat(format);
    ...
    }, props === null || props === void 0 ? void 0 : props.label), (0, _preact.h)("input", {
        type: "date",
...
},{"preact":"26zcy","luxon":"dpK6X","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/date.module.less":"cQkJA"}],"dpK6X":[function(require,module,exports) {
"use strict";
...
},{}],"cQkJA":[function(require,module,exports) {
module.exports["date-component"] = `ruhqTa_date-component`;
...
/** @jsx h */ var _preact = require("preact");
var _selectModuleLess = require("../less/select.module.less");
var SelectComponent = function(props) {
    return (0, _preact.h)("div", {
        className: _selectModuleLess["select-component"]
    }, (0, _preact.h)("label", {
        for: props === null || props === void 0 ? void 0 : props.id
    }, props === null || props === void 0 ? void 0 : props.label), (0, _preact.h)("select", {
        name: props === null || props === void 0 ? void 0 : props.name,
        id: props === null || props === void 0 ? void 0 : props.id,
        required: props === null || props === void 0 ? void 0 : props.required
    }, (0, _preact.h)("option", {
...
},{"preact":"26zcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/select.module.less":"lyYat"}],"lyYat":[function(require,module,exports) {
module.exports["select-component"] = `n3Wudq_select-component`;

},{}],"3KUrv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "NumberComponent", ()=>NumberComponent);
/** @jsx h */ var _preact = require("preact");
var _numberModuleLess = require("../less/number.module.less");
...
},{"preact":"26zcy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../less/number.module.less":"dlGrQ"}],"dlGrQ":[function(require,module,exports) {
module.exports["number-component"] = `L2PyNG_number-component`;

},{}],"4D7r1":[function(require,module,exports) {
module.exports["col"] = `Po1SoG_col`;
module.exports["grid"] = `Po1SoG_grid`;
module.exports["search-form"] = `Po1SoG_search-form`;

},{}],"1UFii":[function(require,module,exports) {
module.exports = Promise.all([
    ...
    require("./helpers/browser/css-loader")(require("./helpers/bundle-url").getBundleURL("9E0vV") + "results.route.ea904548.css" + "?" + Date.now()).catch((err)=>{
        delete module.bundle.cache[module.id];
        throw err;
    }),
...
},{"../cacheLoader":"j49pS"}],"i5LP7":[function() {},{}]},["23m5W","41oNQ"], "41oNQ", "parcelRequired508")
